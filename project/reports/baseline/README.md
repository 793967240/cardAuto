...
> 阶段 1 平衡基线 - 起手卡牌仓库 (剑修 5 卡) vs 5 个敌人各 1000 局的统计快照。
...
- 起手卡牌仓库组成 (`tests/baseline_runner.gd:STARTER_DECK_PATHS`)
...
1. **Stone Guard 胜率 1.000，超出预期 [0.4, 0.85] 区间**：起手卡牌仓库对所有敌人都满胜率，
   说明阶段 1 MVP 卡牌仓库整体偏强 / 敌人 AI 偏弱。**不在阶段 1 工程批次内调整**，
