...
signal chain_cycle_completed(combatant_id: StringName)
...
signal gem_attached(base_id: StringName, socket_index: int, gem_id: StringName)
signal gem_removed(base_id: StringName, socket_index: int)
