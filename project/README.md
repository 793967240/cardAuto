...
| `e2e/` | 完整分叉路线通关日志（gut 集成测试副产物） | 战斗/地图/存档变更后通过 gut 自动产出 |
...
| 2 · 构筑深度 | 🟡 宝石循环闭环完成 | BuildScene 8 底座 + 宝石挂载 + 战斗触发 + 战斗奖励获取已通；卡池/宝石铺量与 baseline 重做下一批 |
| 3 · Roguelike 外壳 | 🟡 分叉地图样品完成 | 类杀戮尖塔逐层路线选择 + 宝箱房已接入；商店/事件/遗物效果与 Act 2 待铺 |
